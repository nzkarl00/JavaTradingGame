...
public class GameManager {
	...
	private void showIslandInfo(Island island) {
		...
		ArrayList<String> routesInfoList = island.getRoutesDescriptions(player.getShip().getSpeed());
	...
	* */
	private IslandRoute chooseIslandRoute(Island fromIsland) {
		...
		ArrayList<String> routeDescriptions = fromIsland.getRoutesDescriptions(player.getShip().getSpeed());
